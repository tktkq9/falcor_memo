...
slangシェーダー（Program）のインターフェースなどを確定させたもの（ProgramKernels）を、ProgramVarsから作られるspecializationArgsによってシェーダーが変わったかどうか判定し（Version）管理するためのクラスであることからProgramVersionと名付けられているのだろうか  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAzOTEyMjMwMiwtMTgyNjk1MDEzNSwtOD
