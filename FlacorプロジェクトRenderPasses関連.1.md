...
slangシェーダー（Program）のインターフェースなどを変数情報（ProgramVars）によって確定させたもの（ProgramKernels）を、ProgramVarsから作られるspecializationArgsによってシェーダーが変わったかどうか（Version）管理するためのクラスであることからProgramVersionと名付けられているのだろうか  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTkxNDQ5MzM5LC0xODI2OTUwMTM1LC04OT
...
MDUzNTg5NiwxNTg2ODUyMzc4LDQ0NTMyNDI1MCwtMTM0OTgxOD
czNiw3ODg2NzcwNDEsLTY0MTUxMTQ1LC0xNzY2MjUyMDgzLC00
MTA5NjA2NzRdfQ==
-->