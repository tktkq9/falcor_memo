...
こいつらにProgramVarsとProgramReflectionを渡すことによりシェーダーブロブやルートシグネチャーが作成される  
そして、これらからGraphicsStateとかでパイプラインステートオブジェクトが作成される  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjU0ODYxMTkzLC05OTEzMzg3NDIsLTIxMj
