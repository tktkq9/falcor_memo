...
サブではないメインParameterBlockReflectionのDefaultConstantBufferは後で実行されるbindIntoDescriptorSet()でバッファー更新を行うので、ここでは更新が必要かチェックを入れるのみ  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTEwNTU5NTk4MywxNDI5ODg1NzMzLDkzNz
