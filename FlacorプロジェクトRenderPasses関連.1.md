...
ちなみにpDeferredはslangのspecialization用（reflectSpecializedType()で用意され、reflectInterfaceType()で評価される）、つまり何のレジスタータイプが使われるかはspecializationされるまでわからないことからpPrimaryが終わった後に評価するために用意されている
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1ODQxMDc1NjQsLTIwMTUyMTUxMjMsMT
