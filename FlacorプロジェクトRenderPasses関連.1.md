...
まずcheckForIndirectChanges()でParameterBlockReflectionの中にある複数のParameterBlockReflectionに対し、更新が必要かチェック、必要ならその印をつけてあとで更新させるようにする  
そして、prepareResources()によってその

ParameterBlockReflectionに対応するリソースそれぞれの処理、つまりバリアー処理が必要ならそれを、バッファーの大きさチェックと確保が必要ならそれを行う  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY1OTkwOTc1OSwxNDI5ODg1NzMzLDkzNz
