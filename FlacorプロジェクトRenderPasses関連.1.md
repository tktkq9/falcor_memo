...
ParameterBlockReflectionに設定されているDescriptorSetInfoの数だけディスクリプターヒープと対応付け、つまりDescriptorSetの配列mSetsの中身の作成DescriptorSet::create()を行い、それがに対応する場合はbindIntoDescriptorSet()も行われる  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwMjM2NDE5OSwtMTAxNTU2NjA1MiwxNj
...
OTQsMTEwNjcyNTEsMTAxMzkyOTc2OCwtOTkxMzM4NzQyLC0yMT
