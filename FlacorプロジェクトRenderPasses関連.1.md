...
ちなみにpDeferredはslangのspecialization用（インターフェースのやつ）、つまり何のレジスタータイプが使われるかはspecializationされるまでわからないことからpPrimaryが終わった後に評価するために用意されている
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE3NTE1MTI3MzgsLTIwMTUyMTUxMjMsMT
