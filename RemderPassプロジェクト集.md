...
### GBufferRT
GBufferのサブクラスで、GBufferのkGBufferChannelsに加えて、以下のkGBufferExtraChannelsをすべてGBufferRT.rt.slangによるDXRによるレイトレにより計算し、RWTexture2Dに格納するパス  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4MTg3MDA5OCwtNDY5NDI3NDY1LDk3OD
