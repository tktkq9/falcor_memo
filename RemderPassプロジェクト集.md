...
さらにmAutoRangeオンの場合は、テクスチャーの最小最大値を（CSMとは微妙に違うComputeParallelReductionを使っているが、GPU処理で）計算し、それを値範囲として指定される  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2MDUyMTgzMDcsLTM3MTM5NjM5MSw0Mj
