...
### GBufferRT
GBufferのサブクラスで、GBufferのkGBufferChannelsに加えて、以下のkGBufferExtraChannelsをGBufferRT.rt.slangによる描画を行い出力するパス  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzODU1NTA3OTUsLTQ2OTQyNzQ2NSw5Nz
