...
それらすべてをRWTexture2Dに格納して出力するパス  
    ...
    const ChannelList kGBufferExtraChannels =
    {
        ...
        { "viewW",          "gViewW",           "View direction in world space"(各ピクセルごとのレイの方向。デバッグ用),    true /* optional */, ResourceFormat::RGBA32Float }, // TODO: Switch to packed 2x16-bit snorm format.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg4Mzc5MzEwLC0yMTMxMzI4OTg2LC0xMz
...
NzUsMTMxOTU3MDA1LDYwNTI2NDM2Myw5MzY1MzY0OCw3OTMxNT
QyNjEsLTEwNzY0Mjk2OCwtNDY5NDI3NDY1LDk3ODYyMTg1XX0=
