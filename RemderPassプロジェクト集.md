...
### GBufferRT
GBufferのサブクラスで、GBufferのkGBufferChannelsに加えて、以下のkGBufferExtraChannelsをすべてGBufferRT.rt.slangによるDXRによりレイトレし、ヒット情報をRWTexture2Dに格納するパス  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNzQ1MDI3ODg4LC0xMDc2NDI5NjgsLTQ2OT
