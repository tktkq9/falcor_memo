...
### GBufferRT
GBufferのサブクラスで、GBufferのkGBufferChannelsに加えて、以下のkGBufferExtraChannelsをすべてGBufferRT.rt.slangによるレイトレにより計算し、RWTexture2Dに格納するパス  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQzNTg2OTAyNiwtNDY5NDI3NDY1LDk3OD
