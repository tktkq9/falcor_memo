...
さらにmAutoRangeオンの場合は、テクスチャーの最小最大値を計算し（CSMとは微妙に違うが、CSMと同じくComputeParallelReductionによるGPU処理で）、それを値範囲として指定される  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0NzMyMzQ2OTYsLTM3MTM5NjM5MSw0Mj
