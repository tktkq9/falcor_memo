...
### GBufferRT
GBufferのサブクラスで、DXRで書かれたGBufferRT.rt.slangを実行し、それによるカメラからのレイトレをし、ヒット情報からGBufferのkGBufferChannelsと以下のkGBufferExtraChannelsを計算しRWTexture2Dに格納するパス  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY5MjgwMjc1OSw3OTMxNTQyNjEsLTEwNz
