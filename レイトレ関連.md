...
hitSurface()関数  
現在ヒットしている頂点のベースLOD（Ray Tracing Gems Chaper 20の式（34）のΔ_i）を計算し、VertexDataに格納  
...
- computeBarycentricDifferentials() : du / dx、du / dy、dv / dx、dv / dyを計算する関数。「Normal-Interpolated Triangles」の部分から導出らしいがわかりづらい。Ray Tracing Gems Chaper 20の式（18）でt = 0のやつと同じなのでこちらを参照したほうがよさげ  
- reflectRayDifferential() : 
- computeNormalDifferentials() : 
- interpolateDifferentials() : 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMTA3NDEyOTksMTQyOTk4NjEyMSwtMT
kwOTQ2NTA2LDE1MTA0NzMwLC0xODAzMzU3MzkwLDQzNTAzMDc5
MiwtMzQyNzc4MjUwLC04NjE1MDE3MjIsMTgzNjgxOTQ4MiwtMz
AyNDczMDk2LDIwNjc3OTc5MjIsMTU5MDY5OTcwLDQyNTMwOTA0
NSwtMTQyMzc1MTIxNyw0Mzg3Mjc4NDMsODI3MzY5MTksLTgzNT
YxMjU3MywtNTAzNjg1OTc1LC0xMzQzMjU3NDQ5LC0xMzc5MTUx
MzE5XX0=
-->