...
そこからsurfaceSpreadAngleを計算（Ray Tracing Gems Cjaper 20の（32）式とは違うが似たような値を計算している。Fig20.7と（32）式の導出の考え方とコードを比較）  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY0ODg2OTkwOSwyMjU3MjY4MDYsLTcwOD
