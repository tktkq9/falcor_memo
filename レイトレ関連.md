...
より上の部分の処理に相当し、各サブオブジェクトに必要なデータを渡しサブオブジェクトRtStateSubobjectBaseを個別に作成とVectorへの格納、それによるD3D12_STATE_OBJECT_DESCの作成を担当する  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwNDU3ODg5NTUsMTg2NzY3NzY3MCwtOT
