...
（DXRはTLAS、BLAS、UAVを使い、ラスタライズで必要なVaoやFboなどはいらないからわざわざGraphicsStateを作る必要はなかったのかも）  

それ以外ではlocalRootSignature、DXR用エントリーポイントの部分を除いてProgramと同じ  
mMaxPayloadSizeとmMaxAttributesSizeは自動設定されないっぽいのでそこは事前に自分で計算して渡す必要があるようだ  


setScene()でシーンを設定する処理があるので、TLAS、BLAS用に使うのかなと思ったが、使われている形跡がないのでこれは多分消し忘れ  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwNDA5MzQzMjQsLTE5MTc1NTY5NzksND
c4NzQxNDEzLC0xNjgxMTY0MDEyLDkyMzEyMDI5MCwxNDkwMzgw
OTQ5LC0xNDc5NzYxNDY4LC0zNTAyNzc0NDQsNjkwMzI3NjI2LD
E0NDA4NDM1MzAsLTE0MjIxMzUyMjYsLTE5OTA2NTgxNjEsMTUx
NTcyOTAyMSwtMTY0NjA4NDIyMiw4ODI1MDQzMzIsMTQ4MDU4MT
QyOCwxNDY5MTE5NTI2LDE0NDE4MzkwNTAsLTEzMzgwNDUyOTIs
LTEzNzY4OTI5NjddfQ==
-->