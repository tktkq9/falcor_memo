...
- computeBarycentricDifferentials() : du / dx、du / dy、dv / dx、dv / dyを計算する関数。「Normal-Interpolated Triangles」の部分から導出らしいがわかりづらい。Ray Tracing Gems Chaper 20の式（18）でt = 0のやつと同じなのでこちらｄ
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQyOTk4NjEyMSwtMTgxNzExMDY3MywtMT
