...
### PathTracer
RenderPassのサブクラスなのでMogwaiで使われたりするレイトレパスのベースクラス  
これのサブクラスがMogwaiで使われ、これ自体は使われない  
...
output : mOutputChannels、サブクラスで指定  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTY5NTk1NTA5MSwtOTcyMzk3ODE1LC04OD
