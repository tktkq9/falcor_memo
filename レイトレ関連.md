...
- generateScatterRay() : 次のパスをサンプルするための関数。BRDF（またはコサイン半球サンプル）で次の反射方向を決定し、その煩瑣h
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwNzIzNTY5NTIsLTE5NTc4NjcyOTksLT
...
LDE0OTc0NDI4NDQsLTE0MjQyOTUzMTMsLTEyOTczMTc3MzEsMT
k4OTgwMjI0MCwxODM3MzEyNDQ0LDE5NzIyMjI4MzksODc5NTc4
MTUsLTE4OTcwMTkxNjNdfQ==
-->