...
- sampleSceneLights() : すべてのライトの内の一つをサンプルし、その結果をSceneLightSampleに格納し返す。SampleGeneratorを消費する  
  - getEnvLightSelectionPdf()やgetEmissiveLightSelectionPdf()やsampleSceneLigh()のコードから分かるように、  
...
sample()で2Dランダム値からサンプルし、  
方向やPDFや光の強さなどのレイトレ用情報をEnvMapSampleに格納し渡す  

### LightHelpers.slang（AnalyticLightSample部分）
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTYwMTM1Nzc2OSwxMTEwMDk3MTMzLDc1Nj
QzMzQzNCw5NTYwMjY1NzIsMjA5Njg1OTcyNyw1NTY5NzA2NTAs
LTE5NzUxNjg3NzksMTY4MTA5MzAxNywxMTE5NTA3OTc5LDEwNT
UyNjg3NTQsNjU2NDUzNzEyLDEwOTgzNzg1ODYsNDkwNzE2OTI4
LDExNjU2NzAwLC0xMzY5NTQ2NTQxLDE4MDUxNTgxNjYsLTM4NT
g1NTE0OCwtMTEwMjYxMzM2OCwtMzkxNjY5ODcsLTIwNzIwMTE5
NzldfQ==
-->