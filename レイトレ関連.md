...
ラスタライズ用の処理applyProgramVarsCommon()で無理やりシェーダーテーブルに設定できるようにするために、このような~~回りくどい~~スマートな実装となっている<color=white>さすがにコードにコメント書いてくれませんかね</color>  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTI1NDA1NjEwMSwtODUzODk3MTI1LC0xOT
