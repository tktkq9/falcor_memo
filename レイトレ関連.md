...
- prepareVerticesForRayDiffs() : computeBarycentricDifferentials()とreflectRayDifferential()で必要なedgeとnormalsとunnormalizedNを計算する関数  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0MzIxMjU3MDYsMTUxMDQ3MzAsLTE4MD
