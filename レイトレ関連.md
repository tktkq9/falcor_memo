...
PathTracer.cppで設定され、StaticParamsの定数決定の値としても使用され（PathTracerParamsの各コメントで最後の方にUse compile-time constant k... in shader.と書いてあるやつがこれ）、  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTg4NTI5MTg3NiwxNDk3Mjc3MjM2LDEyNz
