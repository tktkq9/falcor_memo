...
- RAY_FOOTPRINT_MODE_RAYDIFFS_ISO or RAY_FOOTPRINT_MODE_RAYDIFFS_ANISOの時に使われる  
  ...
  - propagate()でレイヒットした際の情報から、その場所での微分値を更新する
- computeRayDirectionDifferentials() : カメラからのdDdx、dDdyを計算する。式（8）の計算　　
- 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIxMTc2Nzc3MzAsMTgzNjgxOTQ4MiwtMz
...
MzE5LDE2ODYyNTE5NiwtNzUyMzk5MjAsLTQ1NjA0NDAxOSwxND
IzMzg3MTcyLDM3MjMzMjg5OCwxOTY2NDc0MDksLTExNTczMTQ2
NV19
-->