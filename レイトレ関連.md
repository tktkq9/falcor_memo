...
- computeSpreadAngleFromCurvatureIso() : これがRayConeが更新されていく際の角度の計算として使われている。3通りの計算方法があるが、最後のFast Approximationが使われている。これはarcLength ≒ rayConeWidth / dn（平面上でのコーンの面積） = s として、面に対する法線角度の変異 φ = s * 曲率（= dφ/ds）からRayConeのβを計算している。ようするにFig20.7の亜種
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTEzMzA2Njc4OCwxNTE4NTM3NCw1NjU0Mz
gxMjAsLTM2OTYzMTY0MiwxNzUwMTYwMTc1LDE1NDc5ODk5OTIs
MjI1NzI2ODA2LC03MDg4MTMzMzYsLTcwODgxMzMzNiw2NDEzMD
MyNDIsMTMzOTA1MjY0MSwtMzExMjM4NjY4LDE1OTQwOTkzNTUs
LTEyODk2NTkzMzYsLTEyODk2NTkzMzYsLTY5ODg2NDkzMCwxMj
gzODU2MDAsLTEzNzI1NDMyODMsMTQ4NDE2NjQ2NiwtMTMwMzQ3
MTQyNF19
-->