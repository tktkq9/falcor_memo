...
SubTableTypeに対応するエントリーポイントすべてに対し、サブオブジェクト設定バッファーpRecordを取得し、applyRtProgramVars()でサブオブジェクトの作成と設定を行い、バージョン管理l用変数astObservedChangeEpochの更新を行う  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTc2NjIxMjIzOSwxNjM0NDA1NzQ3LDcyNT
