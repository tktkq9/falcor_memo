...
pRecordのハンドル設定はapplyProgramVarsCommon()の呼び出し（この関数は通常はルートシグネチャーと変数ハンドルをコマンドリストに設定する関数）で行われるが、RtVarsCmdList
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTU3NTEzOTY4OCwtMjA2MzQxNDIyNCwtMT
