...
PathTracer.cppからシェーダーに渡された後、PathTracer.slangでこの情報をもとにレイトレを行っていく  
...
メッシュ情報はslots[INTERIOR_LIST_SLOT_COUNT]に保管され、handleIntersection()によってレイのenter、leftによるメッシュ情報のadd or remove処理とその配列に対するプライオリティによるソートが行われる  
現状はINTERIOR_LIST_SLOT_COUNT = 2なので3つ目のメッシュがあらｗ

slots[]は  
NestedPriorityBit 4, ActiveBit 1,  MaterialBit 27  
の32ビットで情報管理されているがこのビットに直接アクセスはせず、  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTM5MTY2OTg3LDc5NDc1MDQyMywtMjA3Mj
AxMTk3OSwtOTU0MTE3NTczLDE4NDI3ODkwMTUsMTM1ODIwODM0
MywxNDc4Mzg2NzM5LDkwODI0ODg4NSwxNDk3Mjc3MjM2LDEyNz
Q3NDQ1NjQsMjQ5MTYxNDY3LDkxNzk5OTIyLC04ODU5NDYwMzEs
LTIwMTAwODk5NTAsLTg5NjYyNTc5LDcwNzYzMzEyNCwxODc1MD
UwNzk2LC03NTEyNTI2OCwyMDE2Nzg2NTU1LC05NzIzOTc4MTVd
fQ==
-->