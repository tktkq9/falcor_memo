...
ラスタライズ用の処理applyProgramVarsCommon()で無理やりシェーダーテーブルに設定できるようにするために、このような~~回りくどい~~スマートな実装となっている<color="Aqua">さすがにコードにコメント書いてくれませんかね</color>  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTMwOTE4MTk5MCwtODUzODk3MTI1LC0xOT
