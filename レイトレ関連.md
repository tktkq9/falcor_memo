...
ラスタライズ用の処理applyProgramVarsCommon()で無理やりシェーダーテーブルに設定できるようにするために、このような~~回りくどい~~スマートな実装となっているさすがにコードにコメント書いてくれませんかね  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk1NzQwNjEwNCwtODUzODk3MTI1LC0xOT
