...
あたりの書き換えが必要となる、DXR用の処理が必要な部分の実装  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTAwNTg1MTE3NCwyMTMwNzExNjA5LC02NT
