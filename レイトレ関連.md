...
- computeScreenSpaceSurfaceSpreadAngle(float3 positionW, float3 normalW, float betaFactorK1 = 1.0, float betaFactorK2 = 0.0) : Ray Tracing Gems Cjaper 20の（32）式。
- 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU3NjUwMjA4NSwxNzUwMTYwMTc1LDE1ND
