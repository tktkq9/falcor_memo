...
### MaterialShading.slang（レイトレ部分）
BSDF、ディフューズ、スペキュラーなどのサンプリングとPDF取得する関数がまとめられている  
_USE_LEGACY_SHADING_CODEによってそれらの計算方法が変更されるのがここ（そしてここのみでしか_USE_LEGACY_SHADING_CODEは影響しない）  
...
参考文献   [PRTT 12 Light Sources](http://www.pbr-book.org/3ed-2018/Light_Sources.html)
ただし計算方法は微妙に違うっぽい（そしてPBRｔのDistantLightはDirectionalLightのことだったりする）  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTYxMjEyMDcwLC0xNDI0Mjk1MzEzLC0xMj
k3MzE3NzMxLDE5ODk4MDIyNDAsMTgzNzMxMjQ0NCwxOTcyMjIy
ODM5LDg3OTU3ODE1LC0xODk3MDE5MTYzLC0xODQ4ODcyNDM1LD
ExMTAwOTcxMzMsNzU2NDMzNDM0LDk1NjAyNjU3MiwyMDk2ODU5
NzI3LDU1Njk3MDY1MCwtMTk3NTE2ODc3OSwxNjgxMDkzMDE3LD
ExMTk1MDc5NzksMTA1NTI2ODc1NCw2NTY0NTM3MTIsMTA5ODM3
ODU4Nl19
-->