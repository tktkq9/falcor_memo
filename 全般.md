...
参考として[slang/example](https://github.com/shader-slang/slang/tree/master/examples)  に簡単な実装例があり、とりあえず[http://slang/examples/hello-world/](https://github.com/shader-slang/slang/tree/master/examples/hello-world)と[]()を見れば大体分かる    
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExMzYxOTM5MSwxNjIyODcyMDg1LDE2OD
