...
ProgramVarsが外部用、ProgramReflectionが変数と番号などの対応付け情報、ParameterBlockがその番号やオフセットやらに対する変数の格納場所となっている  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwMTM2MzE3OTcsLTEwMzUxMzgxMjksMT
E1OTAwMDAyMiwxOTA0NDU2MzU0XX0=
-->