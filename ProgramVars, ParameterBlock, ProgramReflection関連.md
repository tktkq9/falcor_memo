...
ちなみに一つのProgramVars（ParameterBlockのサブクラスなのでParameterBlockでもある）がシェーダーの変数すべてを担当しているのでこれ一つでいいんじゃないかと思われる  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTI5MDU4MTEzMiwtMTM3NjQwMzI1NSwxMj
