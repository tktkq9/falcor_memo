...
ProgramVarsが外部用、  
ProgramReflectionが変数名と番号の対応付け情報、  
ShaderVarがProgramReflectionをもとにParameterBlockから変数持ってくるための橋渡し、  
ParameterBlockがCPU側変数の格納場所といった持ち回りになっている（と思われる）  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTc0MTU5OTkwMCwxOTY3MTU0NDU5LDg3ND
