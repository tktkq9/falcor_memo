...
ちなみに一つのProgramVars（ParameterBlockのサブクラスなのでParameterBlockでもある）が一つのPassに対応するシェーダーの変数すべてを担当しているのでこれ一つでいいはず。複数使うパターンもあるのかもしれない、知らんけど  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTYxNzkwNzQzMiwxNTIyMjQzOTA5LC0xMz
