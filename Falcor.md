...
mpRendererが渡したIRenderer、pBar は描画する前に表示されるプログレスバー、mFrameRateはフレームレート管理、gpDevice->flushAndSync();は終わる前に現行のコマンドキューを終わらすシャットダウン処理
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTkzNjIzODMzNSwxNzg5NTMzMDQyLC0xOT
