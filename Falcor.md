...
（windowのwhileループとそこでのSample::renderFrame()  の実行による）mpRenderer->onFrameRender()の実行（とonGuiRender()の実行。そのほかイベント的なやつもここで処理？）
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTU0Mzg1NTc4NywyOTAyMTA5MDcsMTc4OT
