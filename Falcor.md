...
mpRendererが渡したIRenderer、pBar は描画する前に表示されるプログレスバー、mFrameRateはフレームレート管理、gpDevice->flushAndSync();は最後に残ったコマンドキューが終わるまで待つシャットダウン処理
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1NTUwMzk0NCwxNzg5NTMzMDQyLC0xOT
