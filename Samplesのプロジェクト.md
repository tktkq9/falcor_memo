...
コードにあるようにシェーダーに対応する構造体と変数をstringで指定することによってシェーダー変数を設定できる（この記述はFullScreenPass::SharedPtrがParameterBlockSharedPtr<>にしていることより可能となっている）  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2MjgwMDY3MCwtMTUyNzM0Mjk3MywtOD
