...
nodesは親から始まり、2つの子ノードに再帰的に分割されていく。残りのトライアングルがmaxTriangleCountPerLeaf以下になったらリーフノードにして終わり  
  - リーフノード処理では、リーフノードができ次第triangleIndicesにそのリーフのトライアングルのtriangleIndexを全部入れ、  
triangleBitmasksにはtriangleIndexの場所にbitmask（）
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIzNjU1MjUwLC0xOTE2Njk2NDQ2LDE5NT
c1ODE0NDcsLTExNjg4MDI3MCwtMTczMjAzNjE1Myw4NzI3NDI0
MywxMDAyMTcyMTQ2LC0zNTY4NjMzMTMsMTAxNTA5MDQwMCwzND
g5NTAyMDIsMjE4MTMyOTAyLC0yODI4NzkxMzIsLTk5MjIwNDAz
LC0xNTkxNjAwNzAzLC0xODcwNDgzMzAyLDk5NjU5MDkyNiwtOD
E4NTQzNjkxLC0xNzk4NTgyNzQxLDIzOTM5OTYyLC0xODY2NjI4
NjI5XX0=
-->