...
その平均ベクトルと各トライアングルのconeDirectionベクトル間の角度をcomputeCosConeAngle()で計算し（ここの計算ではすべてtd.cosConeAngle = 1なので実質cosDiffThetaの計算のみ）、最も角度の大きいcosThetaを返す  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTIwNTcwNTkxMiwyMDc3NTk0MzEsMTIwMj
