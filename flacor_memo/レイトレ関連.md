...
直接dataはいじらずに、情報取得用の関数を用いる  
この関数からInternalNode構造体とかLeafNode構造体とかSharedNodeAttributes構造体とかを取得し、CPU、GPU双方でなんやかんやする
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5NjA3NDAyNTUsMTQ1NTA0ODcwNSwtMT
