...
##### build()周り
buildInternal()をして、そのあと出来たBuildingData dataに対しcomputeLightingConesInternal()でnodeそれぞれのcosConeAngleとconeDirectionを計算、設定する  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTkzNzU4Mjc1MywtMzU2ODYzMzEzLDEwMT
