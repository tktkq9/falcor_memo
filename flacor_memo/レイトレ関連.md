...
こちらのデフォルトはノードのトライアングルは10個、ビンニング分割数16、3軸分割、SAOH、ライトコーン使うといった設定になっている（これもCh18を見ると、アップデート速度とクオリティのバランスが一番いいっぽい設定になっている）  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE0MTI5NzEzMDQsMjM5Mzk5NjIsLTE4Nj
