...
EmissiveLightSamplerHelpers.slangの関数を使っているのでEmissiveUniformSamplerの時と同じく、トライアングルのpdfは正確なpdfではなく、式（12）の余分な係数がついていることに注意  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEzODU4MjMxNjgsLTE5MjA3MzQ1NTIsMT
