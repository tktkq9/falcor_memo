...
このdatabuildInternal()をして、そのあと出来たBuildingData dataに対しcomputeLightingConesInternal()でnodeそれぞれのcosConeAngleとconeDirectionを計算、設定する  
最後に
- buildInternal() : 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQyNzM4NDMzOCwtMzU2ODYzMzEzLDEwMT
