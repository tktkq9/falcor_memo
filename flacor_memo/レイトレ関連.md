...
なのでdataの中身とかは別知らんくてもいい  

##### LightBVHRefit.slang
リーフノード更新用のエントリーポイントupdateInternalNodes()と、  
リーフじゃないノード更新用のエントリーポイントupdateLeafNodes()のやつ  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTczMTM1MDg3MSwxNDU1MDQ4NzA1LC0xND
