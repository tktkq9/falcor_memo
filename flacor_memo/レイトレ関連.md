...
EmissiveLightSamplerHelpers.slangの関数を使っているのでEmissiveUniformSampler時と同じく、トライアングルのpdfは正確なpdfではなく、式（12）の余分な係数がついていることに注意  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjEwMjg2MzE3NiwtMTkyMDczNDU1MiwxMT
