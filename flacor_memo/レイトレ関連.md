...
これらの積を返す  
ちなみにevalBVHTraversalPdf()のために、トライアングルインデックスではなく、それに対応するノードトラバース情報（_lightBVH.triangleBitmasks[）を事前に格納したbitmaskを用いる  
- evalBVHTraversalPdf() : 
- evalNodeSamplingPdf() : 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTgxNzI4MTQ0NywxNzM4OTIxMDY4LDQyMD
