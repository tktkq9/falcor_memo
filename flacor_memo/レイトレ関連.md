...
- computeNormalDifferentials() : 「Normal-Interpolated Triangles」の部分のdN/dx、dN/dyを計算して返す関数  
計算に使うdn/dx、dn/dyはinterpolateDifferentials()から取得  
- interpolateDifferentials() : 「Normal-Interpolated Triangles」の部分のdN/dx、dなにか/dyを計算して返す関数  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTA2MjE2NzM5NiwtMzc5OTA1OTIwLC0yMT
EwNzQxMjk5XX0=
-->