...
これはboundCosineTerm()でのみ使われる、ある点から見たAABBに対し、それを囲むコーンの角度（θ_u）を計算する複数の関数の内の1つを選ぶためのenum  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTEwMjk2Nzk1LDEyMDIzMjY0OTAsMTczOD
kyMTA2OCw0MjAyMjY0MzUsMTU1ODc3NDk4OCwxMzkzNjYxMjM0
LC03OTEzMjE3MDYsLTE5MjA3MzQ1NTIsMTEyNzAzMTE2NywxMj
