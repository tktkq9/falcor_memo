...
Optionsでそのサンプル方法を設定でき、デフォルトではCh18全部入り、リーフノードの複数トライアングルはUniformでサンプルとなっている（Cuこれがクオリティと速さ両方を考慮したとき一番バランスが取れている設定っぽい）  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI2MzY2NTEwOSwyMzkzOTk2MiwtMTg2Nj
