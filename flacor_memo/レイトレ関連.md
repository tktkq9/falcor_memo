...
##### build()周り
buildInternal()をして、そのあと出来たBuildingData dataに対しcomputeLightingConesInternal()でnodeのcosConeAngleとconeDirection
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTEzMDE4OTY2NywtMzU2ODYzMzEzLDEwMT
