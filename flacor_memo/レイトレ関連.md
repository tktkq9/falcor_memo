...
その平均ベクトルと各トライアングルのconeDirectionベクトル間の角度をcomputeCosConeAngle()で計算し（ここの計算ではcosOtherTheta = 0なので実質cosDiffThetaの計算のみ）、最も角度の大きいcosThetaを返す  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEwMzI4MzQ3MTMsMjA3NzU5NDMxLDEyMD
