...
EmissiveUniformSamplerと同様に、（要するにIEmissiveLightSamplerを継承したほかのサンプラー同様に）  
sampleLight()とevalPdf()の2つの関数とそれを計算するためのpri
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI5NDMwMjM1MywxNzM4OTIxMDY4LDQyMD
