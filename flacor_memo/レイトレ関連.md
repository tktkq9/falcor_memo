...
このクラスではPathTracerParams mSharedParams（パストレアルゴリズム周りの設定）のUI表示とその値変更が妥当か判定  
その値をもとにしたライトとそのサンプラーの設定を行っている  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDU4NjY2NDg4LC0xMDgwMTg1NTYzLDEwMT
