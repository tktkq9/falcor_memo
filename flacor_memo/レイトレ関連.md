...
中身はほぼ全部build()関数とその仲間たち  

create()時点（コンストラクタ時点）でば何もしない  
LightBVHSamplerから渡されたOptionを設定するだけ  

renderUI()はOptionの設定のみ  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMjExMjE2ODk0NiwtMjgyODc5MTMyLC05OT
...
NTgyMSwtMTE2MzE4MzcsLTMzMzI0MDI3NSwtNzM2NDA2MDEyLD
IxNDY3NTIyMTksLTE5NjM5MjQ1MDIsLTE5NzY5MDE5OTQsMjU2
Njk4NDUwXX0=
-->