...
単純なレイトレなのでバイアスがかかっておらず（ただしsample_cosine_hemisphere_concentric(()による散乱方向のサンプリングがされておりこの部分はバイアスがかかっている）、おそらく確認用に使われるであろうもの  
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbOTQyMzgxMzU0LDEyNzg0NTc0NCwtMTM4MT
